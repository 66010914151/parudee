        ...
        <div class="col-lg-7 col-md-9">
            ...
            <div class="mt-4">
                ...
                if (isset($_POST['Submit'])) {
					...
					$sql="INSERT INTO application (a_id,a_position,a_prefix,a_fullname,a_birth,a_education,a_experience,a_email) VALUES (null,'{$position}','{$prefix}','{$fullname}','{$birth}','{$education}','{$experience}','{$email}');";
